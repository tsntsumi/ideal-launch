          ...
          {({ open }) => (
            <>
              <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
                <div className="order-1 hidden w-full flex-col items-center justify-between md:order-none md:flex md:w-auto md:flex-1 md:flex-row">
            ...
            <div className="order-2 hidden w-full flex-col items-center justify-between md:order-none md:flex md:w-auto md:flex-1 md:flex-row">
